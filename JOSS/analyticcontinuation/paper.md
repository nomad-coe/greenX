...
Analytic continuation (AC) is used in different scientific fields where complex analysis is relevant including mathematical function theory and engineering for solving differential equations [@lope2002analytic]. Another major application area is theoretical physics and chemistry, particularly in fields such as quantum mechanics [@golze2019gw; @li2020real] or quantum field theory [@nekrasov2024analytic]. In the following, we discuss the four examples depicted in Figure&#160;1. The first example, shown in the top left of Figure&#160;1, involves the application of AC to model functions, which may include Gamma functions [@luke1975error], Zeta functions [@iriguchi2007estimation], and others. 
